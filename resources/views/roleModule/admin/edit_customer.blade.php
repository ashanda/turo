          ...
          <form id="formAccountSettings" action="{{ route('all_customer.update',$id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
              ...
              <div class="mb-3 col-md-6">
                ...
                <br>
                <!-- <input class="form-control" type="text" id="passport_photo" name="passport_photo" value="{{ $customer->passport_photo }}" placeholder="upload passport photo" readonly> -->
                <!-- image for passport photo -->
                <a id="passport_photo" target="_blank" href="https://picsum.photos/600/400"><img class="img-fluid" src="https://picsum.photos/600/400" alt=""></a>
              </div>
              <div class="mb-3 col-md-6">
                ...
                <div class="row">
                  <div class="col-sm-12 col-md-6">
                    <div class="mt-2 col-md-6">
                      ...
                      <!-- image for nic font photo -->
                      <a id="nic_front" target="_blank" href="https://picsum.photos/600/400"><img class="img-fluid" src="https://picsum.photos/600/400" alt=""></a>
                    </div>
                  </div>
                  <div class="col-sm-12 col-md-6">
                    <div class="mt-2 col-md-6">
                      ...
                      <!-- image for nic back photo -->
                      <a id="nic" target="_blank" href="https://picsum.photos/600/400"><img class="img-fluid" src="https://picsum.photos/600/400" alt=""></a>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="row">
                  <div class="col-sm-12 col-md-6">
                    <div class="mt-2 col-md-6">
                      ...
                      <!-- image for dl font photo -->
                      <a id="driving_license_front" target="_blank" href="https://picsum.photos/600/400"><img class="img-fluid" src="https://picsum.photos/600/400" alt=""></a>
                    </div>
                  </div>
                  <div class="col-sm-12 col-md-6">
                    <div class="mt-2 col-md-6">
                      ...
                      <!-- image for dl back photo -->
                      <a id="driving_license_back" target="_blank" href="https://picsum.photos/600/400"><img class="img-fluid" src="https://picsum.photos/600/400" alt=""></a>
                    </div>
                  </div>
                </div>
              </div>
